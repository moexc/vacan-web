...
import themeConfigStore, { toggleAnimation, toggleLayout, toggleMenu, toggleNavbar, toggleRTL, toggleTheme, toggleSemidark } from '../../store/themeConfigStore';
                        ...
                        <div className="mt-5 text-primary">
                            <label className="inline-flex mb-0">
                                <input
                                    ...
                                    checked={themeConfig.semidark === true || themeConfigStore.semidark === 'true'}
